...
public static unsafe class WrapperFunctions
{
	...
	public static void Initialize(IntPtr* ptr)
	{
		...
		player_get_equipped_item = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 48);
		player_freeze = (delegate* unmanaged[Cdecl]<IntPtr, Vector3d, void>) *(ptr + 49);
		player_is_frozen = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 50);
		player_unfreeze = (delegate* unmanaged[Cdecl]<IntPtr, void>) *(ptr + 51);
		root_broadcast_chat = (delegate* unmanaged[Cdecl]<string, MessageType, void>) *(ptr + 52);
		root_get_default_world = (delegate* unmanaged[Cdecl]<IntPtr>) *(ptr + 53);
		root_for_each_world = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 54);
		root_for_each_player = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 55);
		client_handle_get_player = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 56);
		world_are_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 57);
		world_set_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool, void>) *(ptr + 58);
		world_get_name = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 59);
		world_get_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, BlockType>) *(ptr + 60);
		world_set_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, BlockType, byte, void>) *(ptr + 61);
		world_broadcast_chat = (delegate* unmanaged[Cdecl]<IntPtr, string, IntPtr, MessageType, void>) *(ptr + 62);
		world_dig_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, IntPtr, void>) *(ptr + 63);
		world_do_explosion_at = (delegate* unmanaged[Cdecl]<IntPtr, double, Vector3d, bool, ExplosionSource, IntPtr, void>) *(ptr + 64);
		world_get_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode>) *(ptr + 65);
		world_get_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather>) *(ptr + 66);
		world_set_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather, void>) *(ptr + 67);
		world_get_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int>) *(ptr + 68);
		world_set_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int, void>) *(ptr + 69);
		world_get_world_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 70);
		world_get_world_tick_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 71);
		world_get_world_date = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 72);
		world_for_each_player = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, bool>) *(ptr + 73);
		create_item = (delegate* unmanaged[Cdecl]<short, byte, short, string, string, IntPtr, int, IntPtr>) *(ptr + 74);
		delete_item = (delegate* unmanaged[Cdecl]<IntPtr, void>) *(ptr + 75);
		create_pickup = (delegate* unmanaged[Cdecl]<Vector3d, IntPtr, bool, Vector3f, int, bool, IntPtr>) *(ptr + 76);
		delete_pickup = (delegate* unmanaged[Cdecl]<IntPtr, void>) *(ptr + 77);
