...
public static unsafe class WrapperFunctions
{
	...
	public static delegate* unmanaged[Cdecl]<IntPtr, IntPtr, bool> entity_is_a;
	...
	public static void Initialize(IntPtr* ptr)
	{
		...
		entity_is_a = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, bool>) *(ptr + 20);
		...
		player_get_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode>) *(ptr + 28);
		player_set_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode, void>) *(ptr + 29);
		player_get_inventory = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 30);
		player_get_name = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 31);
		player_set_visible = (delegate* unmanaged[Cdecl]<IntPtr, bool, void>) *(ptr + 32);
		player_get_uuid = (delegate* unmanaged[Cdecl]<IntPtr, Guid>) *(ptr + 33);
		player_get_client_handle = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 34);
		player_send_message = (delegate* unmanaged[Cdecl]<IntPtr, string, void>) *(ptr + 35);
		player_feed = (delegate* unmanaged[Cdecl]<IntPtr, int, double, bool>) *(ptr + 36);
		player_set_respawn_location = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, IntPtr, void>) *(ptr + 37);
		root_broadcast_chat = (delegate* unmanaged[Cdecl]<string, MessageType, void>) *(ptr + 38);
		root_get_default_world = (delegate* unmanaged[Cdecl]<IntPtr>) *(ptr + 39);
		root_for_each_world = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 40);
		root_for_each_player = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 41);
		client_handle_get_player = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 42);
		world_are_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 43);
		world_set_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool, void>) *(ptr + 44);
		world_get_name = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 45);
		world_get_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, BlockType>) *(ptr + 46);
		world_set_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, BlockType, byte, void>) *(ptr + 47);
		world_broadcast_chat = (delegate* unmanaged[Cdecl]<IntPtr, string, IntPtr, MessageType, void>) *(ptr + 48);
		world_dig_block = (delegate* unmanaged[Cdecl]<IntPtr, Vector3i, IntPtr, void>) *(ptr + 49);
		world_do_explosion_at = (delegate* unmanaged[Cdecl]<IntPtr, double, Vector3d, bool, ExplosionSource, IntPtr, void>) *(ptr + 50);
		world_get_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode>) *(ptr + 51);
		world_get_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather>) *(ptr + 52);
		world_set_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather, void>) *(ptr + 53);
		world_get_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int>) *(ptr + 54);
		world_set_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int, void>) *(ptr + 55);
		world_get_world_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 56);
		world_get_world_tick_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 57);
		world_get_world_date = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 58);
		world_for_each_player = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, bool>) *(ptr + 59);
		create_item = (delegate* unmanaged[Cdecl]<short, byte, short, string, string, IntPtr, int, IntPtr>) *(ptr + 60);
		delete_item = (delegate* unmanaged[Cdecl]<IntPtr, void>) *(ptr + 61);
