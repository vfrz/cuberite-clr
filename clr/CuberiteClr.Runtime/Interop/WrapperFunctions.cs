...
public static unsafe class WrapperFunctions
{
	...
	public static void Initialize(IntPtr* ptr)
	{
		...
		inventory_add_item = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, byte>) *(ptr + 15);
		player_get_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode>) *(ptr + 16);
		player_set_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode, void>) *(ptr + 17);
		player_get_inventory = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 18);
		player_get_name = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 19);
		player_set_visible = (delegate* unmanaged[Cdecl]<IntPtr, bool, void>) *(ptr + 20);
		player_get_uuid = (delegate* unmanaged[Cdecl]<IntPtr, Guid>) *(ptr + 21);
		player_get_client_handle = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr>) *(ptr + 22);
		root_broadcast_chat = (delegate* unmanaged[Cdecl]<string, MessageType, void>) *(ptr + 23);
		root_get_default_world = (delegate* unmanaged[Cdecl]<IntPtr>) *(ptr + 24);
		world_are_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool>) *(ptr + 25);
		world_set_command_blocks_enabled = (delegate* unmanaged[Cdecl]<IntPtr, bool, void>) *(ptr + 26);
		world_get_block = (delegate* unmanaged[Cdecl]<IntPtr, int, int, int, BlockType>) *(ptr + 27);
		world_set_block = (delegate* unmanaged[Cdecl]<IntPtr, int, int, int, BlockType, byte, void>) *(ptr + 28);
		world_broadcast_chat = (delegate* unmanaged[Cdecl]<IntPtr, string, IntPtr, MessageType, void>) *(ptr + 29);
		world_dig_block = (delegate* unmanaged[Cdecl]<IntPtr, int, int, int, IntPtr, void>) *(ptr + 30);
		world_do_explosion_at = (delegate* unmanaged[Cdecl]<IntPtr, double, double, double, double, bool, ExplosionSource, IntPtr, void>) *(ptr + 31);
		world_get_game_mode = (delegate* unmanaged[Cdecl]<IntPtr, GameMode>) *(ptr + 32);
		world_get_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather>) *(ptr + 33);
		world_set_weather = (delegate* unmanaged[Cdecl]<IntPtr, Weather, void>) *(ptr + 34);
		world_get_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int>) *(ptr + 35);
		world_set_time_of_day = (delegate* unmanaged[Cdecl]<IntPtr, int, void>) *(ptr + 36);
		world_get_world_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 37);
		world_get_world_tick_age = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 38);
		world_get_world_date = (delegate* unmanaged[Cdecl]<IntPtr, long>) *(ptr + 39);
		create_item = (delegate* unmanaged[Cdecl]<short, byte, short, string, string, IntPtr, int, IntPtr>) *(ptr + 40);
		delete_item = (delegate* unmanaged[Cdecl]<IntPtr, void>) *(ptr + 41);
